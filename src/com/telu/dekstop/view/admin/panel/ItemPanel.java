...
import com.telu.dekstop.view.admin.dialog.ItemDialog;
...
public class ItemPanel extends javax.swing.JPanel {
    ...
    private DynamicTableModel<Item> tableModel;
    ...
    public ItemPanel() {
        initComponents();
        tableModel = new DynamicTableModel<>(Item.class);
    ...
    public void reload() {
        ...
        List<Item> select = controller.getAll(0, PAGE_SIZE);
        tableModel.clear();
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        dialog.loadCategory();
        Item hasilItem = dialog.tambah();
      
        if(hasilItem != null){
            ItemController controller = new ItemController();
            boolean success = controller.insert(hasilItem);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(jDynamicTable1.getSelectedRow() != -1){
            Item parameter = tableModel.get(jDynamicTable1.convertRowIndexToModel(jDynamicTable1.getSelectedRow()));
       
            ItemDialog dialog = new ItemDialog();
            dialog.loadCategory();
            Item hasilItem = dialog.ubah(parameter);

            if(hasilItem != null){
                ItemController controller = new ItemController();
                boolean success = controller.update(hasilItem);
    ...
    private void jPagination1OnPageChange(com.stripbandunk.jwidget.event.PaginationEvent evt) {//GEN-FIRST:event_jPagination1OnPageChange
        ...
        ItemController controller = new ItemController();
        List<Item> items = controller.getAll(skip, max);
        tableModel.clear();
        for (Item item : items) {
            tableModel.add(item);
        }
